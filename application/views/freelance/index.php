        ...
        <div class="btn-group">
           <button type="button" class="btn custom-button dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu">
                  <a class="dropdown-item" data-name="button-view" data-id="<?=secret_url('encrypt',$freelance->id) ?>">View</a>
                  <a href="<?= base_url('freelance/edit/'.secret_url('encrypt',$freelance->id)) ?>" class="dropdown-item" data-id="<?= secret_url('encrypt',$freelance->id)?>" >Edit</a>
              </div>
           </div> 
