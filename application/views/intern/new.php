<?php $position = $this->Resume_model->fetch('position');
     $role=$this->Resume_model->fetch('resume_role',['pos_id'=>2,'status'=>1]);
...
<hr>
  ...
  <form class="form-horizontal" id="add-intern-form" enctype="multipart/form-data"  method="POST">
      ...
      <div class="modal-body">
        <form class="form-row" method="POST" id="form_role_intern">
            <div class="form-group col-md-6">
              ...
              <input type="hidden" name="pos_id" value="2">
            </div>
